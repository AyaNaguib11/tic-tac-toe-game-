...
def gameboard_pl(game_board, l1, l2):
	...
	for i in range(3):
		...
		for j in range(3):
			...
			button[i][j] = Button(
				game_board, bd=5, command=get_t, height=5, width=9)
...
def withpc(game_board):
	game_board.destroy()
	game_board = Tk()
	game_board.geometry("235x330")
	game_board.eval('tk::PlaceWindow . centre')
...
def play():
	...
	head = Label(menu, text="--- Welcome to tic-tac-toe ---",
				...
				fg="black", width=200, height=2, font='Times', bd=2)

	B1 = Button(menu, text="Single Player", command=wpc,
				activeforeground='red',
				activebackground="white", bg="black",
				fg="white", width=500, height=2, font='Verdana 10 bold', bd=2)

	B2 = Button(menu, text="Two Players", command=wpl, activeforeground='red',
				activebackground="white", bg="black", fg="white",
				width=200, height=2, font='Verdana 10 bold', bd=2)

	B3 = Button(menu, text="Exit", command=menu.quit, activeforeground='red',
				activebackground="white", bg="brown", fg="black",
				width=200, height=2, font='Verdana 10 bold', bd=2)
	head.pack(side='top')
	B1.pack(side='top')
	B2.pack(side='top')
